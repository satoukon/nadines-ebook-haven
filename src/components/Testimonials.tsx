        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Review */}
              <p className="font-inter text-gray-600 mb-6 leading-relaxed italic">
                "{testimonial.review}"
              </p>

              {/* Author */}
              <div className="border-t border-gray-100 pt-4">
                <p className="font-inter font-semibold text-gray-900">{testimonial.name}</p>
                <p className="font-inter text-sm text-brand-primary">{testimonial.role}</p>
              </div>
            </div>
          ))}
        </div>
